...
-- 5) relationship between classification and inventory
ALTER TABLE IF EXISTS public.inventory
  DROP CONSTRAINT IF EXISTS fk_classification;
...
-- 6) Seed data for classification
TRUNCATE TABLE public.classification RESTART IDENTITY CASCADE;
...
VALUES   (
    ...
    '/images/batmobile.webp',
    '/images/batmobile-tn.webp',
    65000,
    29887,
    'Black',
    1
    ...
    '/images/wrangler.webp',
    '/images/wrangler-tn.webp',
    28045,
    41205,
    'Yellow',
    3
    ...
    '/images/adventador.webp',
    '/images/adventador-tn.webp',
    417650,
    71003,
    'Blue',
    2
    ...
    '/images/monster-truck.webp',
    '/images/monster-truck-tn.webp',
    150000,
    3998,
    'purple',
    1
    ...
    '/images/escalade.webp',
    '/images/escalade-tn.webp',
    75195,
    41958,
    'Black',
    4
    ...
    '/images/mechanic.webp',
    '/images/mechanic-tn.webp',
    100,
    200125,
    'Rust',
    5
    ...
    '/images/mystery-van.webp',
    '/images/mystery-van-tn.webp',
    10000,
    128564,
    'Green',
    1
  ...
  (
    ...
    '/images/fire-truck.webp',
    '/images/fire-truck-tn.webp',
    50000,
    38522,
    'Red',
    4
    ...
    '/images/crwn-vic.webp',
    '/images/crwn-vic-tn.webp',
    10000,
    108247,
    'White',
    5
  );
  -- 7) Task One, Query 4: Fixing GM Hummer description
...
-- 7) Task One, Query 6: Adding "/vehicles" into image paths
UPDATE public.inventory
SET inv_image = REPLACE(inv_image, '/images/', '/images/vehicles/'),
    inv_thumbnail = REPLACE(inv_thumbnail, '/images/', '/images/vehicles/');

-- 8) testdrive_request table
DROP TABLE IF EXISTS public.testdrive_request CASCADE;
